...
export default function Edit({ voucher, partCategories = [], parts = [], serviceCategories = [], services = [] }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        scope: voucher.scope || 'transaction',
        min_purchase: voucher.min_purchase || 0,
        max_discount: voucher.max_discount || '',
        can_combine_with_discount: !!voucher.can_combine_with_discount,
        eligible_parts: voucher.eligible_parts || [],
        eligible_part_categories: voucher.eligible_part_categories || [],
        eligible_services: voucher.eligible_services || [],
        eligible_service_categories: voucher.eligible_service_categories || [],
    });
        ...
        <DashboardLayout>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Edit Voucher</h1>
