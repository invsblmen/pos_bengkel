                    ...
                    <>
                        ...
                        {viewMode === 'card' && (
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {liveItems.map((p, idx) => (
                                <div key={p.id} className="rounded-2xl border hover:shadow-xl transition-all duration-200 overflow-hidden shadow-lg bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:border-amber-300 dark:hover:border-amber-700">
                                    {/* Card Header */}
