                                                    ...
                                                    <td className="px-6 py-4 text-center">
                                                        <div className="inline-flex items-center gap-2">
                                                            <button
                                                                ...
                                                                className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 hover:scale-110"
                                                                title="Edit item"
                                                            >
                                                                <IconEdit size={18} />
                                                            </button>
