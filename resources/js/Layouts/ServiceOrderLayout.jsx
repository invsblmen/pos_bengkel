...
export default function ServiceOrderLayout({ children, selectedVehicleId = null, onHistoryClick }) {
                    ...
                    <nav className="hidden lg:flex items-center gap-1">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                                selectedVehicleId
                                    ? 'text-slate-600 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-white dark:hover:bg-slate-800 cursor-pointer'
                                    : 'text-slate-400 dark:text-slate-600 cursor-not-allowed opacity-50'
                            }`}
                            title={!selectedVehicleId ? 'Pilih kendaraan terlebih dahulu' : 'Riwayat Kendaraan'}
                        >
                            <IconHistory size={18} />
                            <span>Riwayat</span>
                        </button>
                    ...
                    >
                        <nav className="p-4 space-y-2">
                            ...
                            >
                                ...
                                <span className="font-medium">Daftar Order</span>
                            </Link>
                            <button
                                type="button"
                                onClick={handleHistoryClick}
